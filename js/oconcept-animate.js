...
class OConceptAnimate {
    ...
    handleFileReplacement(animateVariables) {
    ...
    scanAroundPixel(ctx, startPoint, map) {
        var x;
        var y;
    ...
    findStartingPoint(imagePointMap) {
        var x;
        var y;
    ...
    loadFullImagePoints(ctx, width, height) {
        var imagePointMap = [];
    ...
    //download utility
    download(content, dataUrl, name, type) {
    ...
    convertFileDataToUsableImagePoints(data) {
        return new Promise((resolve, reject) => {
            var points = [];
    ...
    resizeCanvas(widthPercent, heightPercent) {
